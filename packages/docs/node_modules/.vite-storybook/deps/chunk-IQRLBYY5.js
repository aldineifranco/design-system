import {
  ...
  themes,
  useTheme
} from "./chunk-2KUPENZS.js";
import {
  require_string_repeat
} from "./chunk-DEE2SIUJ.js";
import {
  require_react
} from "./chunk-6CE3F7YD.js";
import {
  require_delete_property_or_throw
} from "./chunk-IEF7YD7O.js";
import {
  require_string_trim_forced
} from "./chunk-DP272TGZ.js";
import {
  require_array_fill
} from "./chunk-BZPWJ4HP.js";
import {
  require_runtime
} from "./chunk-6B3MDZ4T.js";
import {
  require_dist
} from "./chunk-YK5EO7I5.js";
import {
  require_string_trim
} from "./chunk-72FPRCDY.js";
import {
  require_lib
} from "./chunk-7ANXQGRA.js";
import {
  require_memoizerific
} from "./chunk-3XATFFJ5.js";
import {
  logger,
  once,
  require_es_regexp_exec
} from "./chunk-KNRBHVSM.js";
import {
...
var LazySyntaxHighlighter = (0, import_react.lazy)(function() {
  return import("./syntaxhighlighter-b07b042a-NKZULD52.js");
});
    ...
    return regeneratorRuntime.wrap(function _callee$(_context) {
      while (1) {
        switch (_context.prev = _context.next) {
          case 0:
            _context.next = 2;
            return Promise.all([import("./syntaxhighlighter-b07b042a-NKZULD52.js"), import("./formatter-0d5cb0eb-SFIYW3X6.js")]);
          case 2:
...
var DocumentWrapper = styled.div(function(_ref36) {
  ...
  return {
    ...
    h2: { fontSize: "".concat(theme.typography.size.m2, "px"), borderBottom: "1px solid ".concat(theme.appBorderColor) },
    ...
    "h1, h2, h3, h4, h5, h6": { margin: "20px 0 10px", padding: 0, cursor: "text", position: "relative", "&:first-of-type": { marginTop: 0, paddingTop: 0 }, "&:hover a.anchor": { textDecoration: "none" }, "& tt, & code": { fontSize: "inherit" } },
    ...
    "body > h1:first-of-type, body > h2:first-of-type, body > h3:first-of-type, body > h4:first-of-type, body > h5:first-of-type, body > h6:first-of-type": { marginTop: 0, paddingTop: 0 },
    "body > h1:first-of-type + h2": { marginTop: 0, paddingTop: 0 },
    "a:first-of-type h1, a:first-of-type h2, a:first-of-type h3, a:first-of-type h4, a:first-of-type h5, a:first-of-type h6": { marginTop: 0, paddingTop: 0 },
    "h1 p, h2 p, h3 p, h4 p, h5 p, h6 p": { marginTop: 0 },
    "li p.first": { display: "inline-block" },
    "ul, ol": { paddingLeft: 30, "& :first-of-type": { marginTop: 0 }, "& :last-child": { marginBottom: 0 } },
    dl: { padding: 0 },
    "dl dt": { fontSize: "14px", fontWeight: "bold", fontStyle: "italic", margin: "0 0 15px", padding: "0 15px", "&:first-of-type": { padding: 0 }, "& > :first-of-type": { marginTop: 0 }, "& > :last-child": { marginBottom: 0 } },
    blockquote: { borderLeft: "4px solid ".concat(theme.color.medium), padding: "0 15px", color: theme.color.dark, "& > :first-of-type": { marginTop: 0 }, "& > :last-child": { marginBottom: 0 } },
    table: { padding: 0, borderCollapse: "collapse", "& tr": { borderTop: "1px solid ".concat(theme.appBorderColor), backgroundColor: "white", margin: 0, padding: 0, "& th": { fontWeight: "bold", border: "1px solid ".concat(theme.appBorderColor), textAlign: "left", margin: 0, padding: "6px 13px" }, "& td": { border: "1px solid ".concat(theme.appBorderColor), textAlign: "left", margin: 0, padding: "6px 13px" }, "&:nth-of-type(2n)": { backgroundColor: theme.color.lighter }, "& th :first-of-type, & td :first-of-type": { marginTop: 0 }, "& th :last-child, & td :last-child": { marginBottom: 0 } } },
    img: { maxWidth: "100%" },
    "span.frame": { display: "block", overflow: "hidden", "& > span": { border: "1px solid ".concat(theme.color.medium), display: "block", float: "left", overflow: "hidden", margin: "13px 0 0", padding: 7, width: "auto" }, "& span img": { display: "block", float: "left" }, "& span span": { clear: "both", color: theme.color.darkest, display: "block", padding: "5px 0 0" } },
    "span.align-center": { display: "block", overflow: "hidden", clear: "both", "& > span": { display: "block", overflow: "hidden", margin: "13px auto 0", textAlign: "center" }, "& span img": { margin: "0 auto", textAlign: "center" } },
    "span.align-right": { display: "block", overflow: "hidden", clear: "both", "& > span": { display: "block", overflow: "hidden", margin: "13px 0 0", textAlign: "right" }, "& span img": { margin: 0, textAlign: "right" } },
    "span.float-left": { display: "block", marginRight: 13, overflow: "hidden", float: "left", "& span": { margin: "13px 0 0" } },
    "span.float-right": { display: "block", marginLeft: 13, overflow: "hidden", float: "right", "& > span": { display: "block", overflow: "hidden", margin: "13px auto 0", textAlign: "right" } },
    "code, tt": { margin: "0 2px", padding: "0 5px", whiteSpace: "nowrap", border: "1px solid ".concat(theme.color.mediumlight), backgroundColor: theme.color.lighter, borderRadius: 3, color: theme.base === "dark" && theme.color.darkest }
  };
});
...
var ActionBar = function ActionBar2(_a) {
  ...
  return import_react.default.createElement(Container$1, Object.assign({}, props), actionItems.map(function(_ref40, index2) {
    ...
    return (
      ...
      import_react.default.createElement(ActionButton, { key: index2, className, onClick, disabled }, title)
    );
  }));
};
...
var GlobalScrollAreaStyles = (0, import_react.lazy)(function() {
  return import("./GlobalScrollAreaStyles-8793ce4a-3IQLMYYA.js");
});
var OverlayScrollbars = (0, import_react.lazy)(function() {
  return import("./OverlayScrollbars-1355f44c-LYCGWTQ5.js");
});
...
var LazyWithTooltip = (0, import_react.lazy)(function() {
  return import("./WithTooltip-167e9982-4YDZXVC3.js").then(function(mod) {
...
var AddonPanel = function AddonPanel2(_ref109) {
  ...
  return (
    ...
    import_react.default.createElement("div", { hidden: !active, style: { transform: "translateX(0px)" } }, useUpdate(active, children))
  );
};
...
var c = { amp: "&", apos: "'", gt: ">", lt: "<", nbsp: " ", quot: "“" };
var a2 = ["style", "script"];
...
var LazyColorControl = (0, import_react.lazy)(function() {
  return import("./Color-f953d088-EJSZN4HB.js");
});
...
var ArgsTable = function ArgsTable2(props) {
  if ("error" in props) {
    return import_react.default.createElement(EmptyBlock, null, props.error, " ", import_react.default.createElement(Link, { href: "http://storybook.js.org/docs/", target: "_blank", withArrow: true }, "Read the docs"));
  }
  ...
  if (groups.ungrouped.length === 0 && Object.entries(groups.sections).length === 0 && Object.entries(groups.ungroupedSubsections).length === 0) {
    return import_react.default.createElement(EmptyBlock, null, "No inputs found for this component. ", import_react.default.createElement(Link, { href: "http://storybook.js.org/docs/", target: "_blank", withArrow: true }, "Read the docs"));
  }
  var colSpan = 1;
  if (updateArgs)
    colSpan += 1;
...
@storybook/components/dist/esm/index-681e4b07.js:
  (*! *****************************************************************************
  ...
  ***************************************************************************** *)
*/
//# sourceMappingURL=chunk-IQRLBYY5.js.map
